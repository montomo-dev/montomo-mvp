...
import { gainExp, MAX_LEVEL, statsFor } from "../js/systems/growth.js";
...
test("ポーションの価格は効果の上昇にきれいに比例する(3倍→6倍→プレミアム)", () => {
  assert.equal(ITEMS.potionS.price, 15);
...
test("配合表を増やすために追加した8つの特殊配合レシピが正しく機能する", () => {
  const recipes = [
    ["hibachi", "sunasasori", "rakudan"],
    ["kaigaran", "pyokotan", "awairuka"],
    ["fuwarisu", "kazeneko", "sorane"],
    ["hagurumaru", "pachikoro", "karakuribat"],
    ["fuyudama", "yukimaro", "kooritsumu"],
    ["akumakko", "kageuri", "kokushou"],
    ["sunamiira", "yuureiking", "tsukihane"],
    ["mizukusa", "noroigumo", "sumiremo"],
  ];
  for (const [a, b, expected] of recipes) {
...
test("進化後の姿を指定した特殊配合レシピが、基礎形への丸め込みより優先される", () => {
  const recipes = [
    ["kotohana", "mofurif", "hanamaro"],
    ["harune", "mofurif", "sakuraneko"],
    ["borudogura", "sunasasori", "sunaboko"],
    ["borudogura", "sunamaru", "sunamiira"],
    ["bakuhibachi", "moriame", "tsuyuhika"],
    ["bakuhibachi", "hikariame", "shizukuya"],
    ["sorane", "tenfuwarisu", "kazepeko"],
    ["kazeneko", "tenfuwarisu", "torimugi"],
  ];
  for (const [a, b, expected] of recipes) {
    const child = breedMonsters(createMonster(a, 15), createMonster(b, 15)).child;
    assert.equal(child.speciesId, expected, `${a}+${b} が ${expected} を生まない`);
...
test("配合表を3倍に増やすために追加した60件の特殊配合レシピが全て正しく機能する", () => {
  const recipes = [
    ...
    ["orihiko", "sorane", "kazepeko"],
    ["kiboko", "sabotenko", "yamakibi"],
    ["kiboko", "tsuboco", "tsubogame"],
    ["kaigaran", "tsuboco", "haribune"],
    ["honbori", "yuureiking", "shizumegane"],
    ["akumakko", "honbori", "takarabox"],
    ["sunamaru", "tsubogame", "hoshimogu"],
    ["kuroguri", "takarabox", "yuureiking"],
    ["awairuka", "pukurin", "sazanami"],
    ["mizutama", "pukurin", "mizugoma"],
    ["hoshimogu", "sunasasori", "sunamaru"],
    ["hoshimogu", "sunamiira", "hoshizora"],
    ["shizumegane", "yamiankou", "shizukuya"],
    ["kuroguri", "yamiankou", "noroigumo"],
    ["pengiri", "yukigamo", "yukimaro"],
    ["fuyudama", "pengiri", "kooritsumu"],
    ["rakudan", "sabotenko", "sunasasori"],
    ["momijiri", "sabotenko", "harune"],
    ["nejiko", "sparkun", "hagurumaru"],
    ["pachikoro", "sparkun", "paipon"],
    ["hagurumaru", "paipon", "nejiko"],
    ["karakuribat", "paipon", "hagurumaru"],
    ["mizuhane", "torimugi", "sandango"],
    ["kotohana", "mizuhane", "mizutama"],
    ["momijiri", "sakuraneko", "hanamaro"],
    ["harune", "momijiri", "kazeneko"],
    ["haribune", "mizugoma", "mizutama"],
    ["sunaboko", "sunobori", "sunamaru"],
    ["sunamaru", "sunobori", "sunasasori"],
    ["kaigaran", "mizutama", "tsubogame"],
    ["hanamaro", "yamakibi", "sakuraneko"],
    ["kiboko", "yamakibi", "sabotenko"],
    ["shizumegane", "tsukihane", "sunamiira"],
    ["haribune", "mizutama", "mizuhane"],
    ["kageuri", "kuroguri", "akumakko"],
    ["kuroguri", "noroigumo", "kageuri"],
    ["kooritsumu", "yukimaro", "yukibouzu"],
    ["fuyudama", "yukigamo", "pengiri"],
    ["haribune", "kaigaran", "pukurin"],
    ["mizutama", "sazanami", "yamiankou"],
    ["shizukuya", "tsuyuhika", "hikariame"],
    ["moriame", "shizukuya", "mizugoma"],
    ["kazepeko", "sorane", "orihiko"],
    ["kazeneko", "torimugi", "honbori"],
    ["ishimaru", "sunaboko", "tsuboco"],
    ["rakudan", "sunamaru", "hoshimogu"],
    ["reiseiou", "yukibouzu", "yukigamo"],
    ["sabotenko", "sunamaru", "sunobori"],
    ["kotohana", "momijiri", "sakuraneko"],
    ["mizukusa", "sumiremo", "noroigumo"],
    ["hoshizora", "sumiremo", "sunamiira"],
    ["sunamiira", "takarabox", "kokushou"],
    ["kokushou", "kuroguri", "akumakko"],
    ["paipon", "sparkun", "pachikoro"],
    ["haribune", "mizuhane", "sazanami"],
    ["ishimaru", "tsubogame", "kurista"],
    ["sunamaru", "yamakibi", "rakudan"],
    ["honbori", "shizumegane", "yamiankou"],
    ["kokushou", "takarabox", "sunamiira"],
  ];
  for (const [a, b, expected] of recipes) {
    const child = breedMonsters(createMonster(a, 15), createMonster(b, 15)).child;
    assert.equal(child.speciesId, expected, `${a}+${b} が ${expected} を生まない`);
...
test("新たに2進化目を追加した6系統(ピョコタン等)がレベル10で正しく進化する", () => {
  const chains = [
    ["pyokotan", "gamadon"],
    ["pachikoro", "pachiking"],
    ["orihiko", "orifalcon"],
